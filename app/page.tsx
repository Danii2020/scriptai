    ...
    <div className="min-h-screen flex flex-col items-center justify-center text-white p-6">
      <header className="flex flex-col items-center gap-4 mb-12">
        ...
        <p className="text-lg sm:text-xl text-center max-w-xl text-[#e0e0e0]">
          Effortlessly generate engaging, long-form or short-form YouTube, TikTok, or Instagram video scripts. Focus on your creativity—let AI handle the words!
        </p>
      </header>
      ...
      <footer className="mt-16 text-sm text-[#b0b0b0] text-center">
        {new Date().getFullYear()} Scriptioo. Made for content creators.
      </footer>
    </div>
  );
}
